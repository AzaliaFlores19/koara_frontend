...
const MOCK_DATA = [
  { client: "Lia Fernanda Ramírez", receipt: 1001, date: "03-05-2025", total: 200.0 },
  { client: "María López",          receipt: 1002, date: "03-05-2025", total: 150.0 },
  { client: "Carlos Ruiz",          receipt: 1003, date: "04-05-2025", total: 320.0 },
  { client: "Ana Martínez",         receipt: 1004, date: "05-05-2025", total: 90.0  },
  { client: "Pedro García",         receipt: 1005, date: "06-05-2025", total: 210.0 },
  { client: "Laura Sánchez",        receipt: 1006, date: "07-05-2025", total: 175.0 },
  { client: "Jorge Torres",         receipt: 1007, date: "08-05-2025", total: 130.0 },
  { client: "Sofía Herrera",        receipt: 1008, date: "09-05-2025", total: 260.0 },
];
      ...
      <div className="bg-white rounded-3xl border border-black overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            {rows.map((r) => (
              <tr key={r.receipt} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 font-medium">{r.client}</td>
                <td className="px-6 py-4 text-center">{r.receipt}</td>
